    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div class="stat-card flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-foreground"><?php echo e($teachers->count()); ?></p>
            </div>
        </div>
        <div class="stat-card flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-foreground"><?php echo e($teachers->where('status', 'Active')->count()); ?></p>
            </div>
        </div>
        <div class="stat-card flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-foreground"><?php echo e($teachers->filter(function($t) { return \Carbon\Carbon::parse($t->join_date)->isCurrentYear(); })->count()); ?></p>
            </div>
        </div>
    </div>
                            ...
                            <tr class="hover:bg-muted/50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="font-medium text-foreground"><?php echo e($teacher->first_name); ?> <?php echo e($teacher->last_name); ?></div>
                                            <div class="text-sm text-muted-foreground"><?php echo e($teacher->email); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 font-mono text-sm"><?php echo e($teacher->id); ?></td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <svg class="w-4 h-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                                        </svg>
                                        <span><?php echo e($teacher->subject ?? 'N/A'); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="space-y-1">
                                        <div class="flex items-center gap-2 text-sm">
                                            ...
                                            <span class="text-muted-foreground"><?php echo e($teacher->email); ?></span>
                                        </div>
                                        <div class="flex items-center gap-2 text-sm">
                                            <svg class="w-3 h-3 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                            </svg>
                                            <span class="text-muted-foreground"><?php echo e($teacher->phone ?? 'N/A'); ?></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="px-2 py-1 text-xs rounded-full <?php echo e($teacher->status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <?php echo e($teacher->status ?? 'Active'); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 text-right text-sm">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="<?php echo e(route('admin.teachers.show', $teacher->id)); ?>" class="text-primary hover:text-primary/80">View</a>
                                        <button @click="openEditDialog('<?php echo e($teacher->id); ?>')" class="text-primary hover:text-primary/80">Edit</button>
                                        <button @click="openDeleteDialog('<?php echo e($teacher->id); ?>')" class="text-destructive hover:text-destructive/80">Delete</button>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <tbody class="divide-y divide-border" x-show="searchQuery !== ''" x-cloak>
                        <template x-for="teacher in filteredTeachers" :key="teacher.id">
                            <tr class="hover:bg-muted/50">
                                ...
                                <td class="px-6 py-4 text-right text-sm">
                                    <div class="flex items-center justify-end gap-2">
                                        <a :href="`<?php echo e(route('admin.teachers.index')); ?>/${teacher.id}`" class="text-primary hover:text-primary/80">View</a>
...
function teacherManagement() {
    return {
        ...
        filteredTeachers: <?php echo json_encode($teachers, 15, 512) ?>,
        isLoading: false,
        errorMessage: '',
        successMessage: '',
        openAddDialog() {
...
<?php echo $__env->make('layouts.dashboard', ['title' => 'Teachers', 'userRole' => 'admin'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\school-hub\resources\views/admin/teachers/index.blade.php ENDPATH**/ ?>