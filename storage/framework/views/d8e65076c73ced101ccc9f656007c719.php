...
<div class="space-y-6" x-data="{ activeTab: 'overview' }">
    <!-- Back Button -->
    <a href="<?php echo e(route('admin.teachers.index')); ?>" class="inline-flex items-center gap-2 text-foreground hover:text-primary transition-colors">
        ...
        <div class="flex items-start gap-6">
            ...
            <div class="flex-1">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h1 class="text-3xl font-bold mb-2"><?php echo e($teacher->first_name); ?> <?php echo e($teacher->last_name); ?></h1>
                        <div class="flex items-center gap-4 text-muted-foreground">
                            <span class="font-mono text-sm">ID: <?php echo e($teacher->id); ?></span>
                            <span class="px-2 py-1 text-xs rounded-full <?php echo e($teacher->status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                <?php echo e($teacher->status); ?>

                            </span>
                        </div>
                    </div>
                    <a href="<?php echo e(route('admin.teachers.index')); ?>?edit=<?php echo e($teacher->id); ?>" class="bg-primary text-primary-foreground px-4 py-2 rounded-md hover:bg-primary/90 transition-colors">Edit Teacher</a>
                </div>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm"><?php echo e($teacher->subject ?? 'N/A'); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        <span class="text-sm"><?php echo e($teacher->email); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <span class="text-sm"><?php echo e($teacher->phone ?? 'N/A'); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        <span class="text-sm">Joined: <?php echo e(\Carbon\Carbon::parse($teacher->join_date)->format('M d, Y')); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-card rounded-xl p-4 shadow-sm border border-border/50">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($students->count()); ?></p>
                </div>
        ...
        <div class="bg-card rounded-xl p-4 shadow-sm border border-border/50">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($teacher->experience ?? 'N/A'); ?></p>
                </div>
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="font-medium"><?php echo e(\Carbon\Carbon::parse($teacher->join_date)->format('M d, Y')); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-muted-foreground">Subject</p>
                            <p class="font-medium"><?php echo e($teacher->subject ?? 'N/A'); ?></p>
                        </div>
                    </div>
                    <?php if($teacher->education): ?>
                    <div>
                        <p class="text-sm text-muted-foreground">Education</p>
                        <p class="font-medium"><?php echo e($teacher->education); ?></p>
                    </div>
                    <?php endif; ?>
                    <?php if($teacher->address): ?>
                    <div>
                        <p class="text-sm text-muted-foreground">Address</p>
                        <p class="font-medium"><?php echo e($teacher->address); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <tbody class="divide-y divide-border">
                        <?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="px-6 py-4"><?php echo e($course->grade ?? 'N/A'); ?></td>
                                <td class="px-6 py-4"><?php echo e($course->student_count ?? 0); ?></td>
                            </tr>
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-border">
                        <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-6 py-4 font-medium"><?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></td>
                                <td class="px-6 py-4 font-mono text-sm"><?php echo e($student->id); ?></td>
                                <td class="px-6 py-4"><?php echo e($student->grade ?? 'N/A'); ?></td>
                                <td class="px-6 py-4 text-sm text-muted-foreground"><?php echo e($student->email ?? 'N/A'); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
        ...
        <div class="bg-card rounded-xl p-6 shadow-sm border border-border/50">
            ...
            <div class="rounded-md border overflow-hidden">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-border">
                        <?php $__empty_1 = true; $__currentLoopData = $schedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-6 py-4 font-medium"><?php echo e($item->name ?? 'N/A'); ?></td>
                                <td class="px-6 py-4"><?php echo e($item->grade ?? 'N/A'); ?></td>
                                <td class="px-6 py-4"><?php echo e($item->schedule ?? 'N/A'); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
...
<?php echo $__env->make('layouts.dashboard', ['title' => 'Teacher Details', 'userRole' => 'admin'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\school-hub\resources\views/admin/teachers/show.blade.php ENDPATH**/ ?>