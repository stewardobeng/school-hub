        ...
        <div class="max-w-4xl w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-card rounded-xl p-6 shadow-sm border border-border/50 hover:shadow-lg transition-all duration-300 animate-fade-in cursor-pointer group" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                        <div class="text-center pb-2">
                            <div class="w-16 h-16 rounded-full <?php echo e($role['color']); ?> flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                                <?php if($role['icon'] === 'Shield'): ?>
                                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                                <?php elseif($role['icon'] === 'GraduationCap'): ?>
                                ...
                                <?php elseif($role['icon'] === 'Users'): ?>
                                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                                <?php endif; ?>
                            </div>
                            <h3 class="text-xl font-semibold text-foreground mb-2"><?php echo e($role['title']); ?></h3>
                            <p class="text-sm text-muted-foreground mb-4"><?php echo e($role['description']); ?></p>
                        </div>
                        <div class="pt-2">
                            <a href="<?php echo e(route($role['route'])); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\school-hub\resources\views/index.blade.php ENDPATH**/ ?>