@extends('layouts.dashboard', ['title' => 'Profile', 'userRole' => 'admin'])
            ...
            <div class="text-center">
                <div class="flex justify-center mb-4">
                    <div class="relative">
                        ...
                        <button @click="document.getElementById('photo-upload').click()" class="absolute bottom-0 right-0 rounded-full w-10 h-10 bg-muted border-2 border-background flex items-center justify-center hover:bg-muted/80 transition-colors">
        ...
        <div class="bg-card rounded-xl p-6 shadow-sm border border-border/50">
            ...
            <form @submit.prevent="handleSaveProfile()" class="space-y-6">
                ...
                <div class="flex gap-3">
                    ...
                    <button type="button" :disabled="isLoading" class="bg-muted text-foreground px-4 py-2 rounded-md hover:bg-muted/80 transition-colors disabled:opacity-50">Cancel</button>
                </div>
            </form>
        </div>
    </div>
